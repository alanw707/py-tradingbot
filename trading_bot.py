...
def main():
    ...
    global buy_price, stop_out_price, in_short_position
            ...
            if not in_position:
                ...
                if amount_to_buy > 10:
                    ...
                    if order:
                        ...
                        stop_out_amount =  buy_price * (1 - stop_loss_threshold_percentage / 100)
                        in_position = True                        
                        log_trade(session, current_timestamp, symbol, 'buy', order['price'], amount_to_buy / ohlcv[-1][4])
